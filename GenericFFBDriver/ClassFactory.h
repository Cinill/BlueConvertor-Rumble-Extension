...
public:
	...
	STDMETHODIMP CreateInstance(LPUNKNOWN pUnkOuter, REFIID riid, LPVOID* ppvObj) override
	{
		*ppvObj = nullptr;
		if (pUnkOuter)
	...
	STDMETHODIMP LockServer(BOOL) override { return S_OK; } // not implemented
};
